...
int maint()
{
	...
	//! иначе -- присвоить переменным student.друг значения противоположных структур, вернуть 1
	...
	//! иначе -- присвоить переменным student.друг значения собственных структур (прим. s1.друг = s1 ), вернуть 1
